...
public class getCatSKU {
	
	/**
	 * 对应30103号接口（获取类目可选SKU）
	 */
	@Test
...
//		for (String x : catNoList){
		...
		String url = LoadAPIInfo.url+LoadAPIInfo.getCatSKUAPI;
		...
		if(returnValue == 0){
			...
			System.out.println("获取类目SKU失败"+responseEntiy);
		}
		System.out.println("获取的类目SKU数量为："+catSKUCount);
//			return list;
