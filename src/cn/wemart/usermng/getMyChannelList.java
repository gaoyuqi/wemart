...
public class getMyChannelList {
	
	/**
	 * 对应20513号接口（获我的取渠道列表）
	 */
	@Test
	public static void getMyChannelTest(){
		
		CloseableHttpClient httpclient = shopLogin.setHttpClient();
		String url = LoadAPIInfo.url+LoadAPIInfo.getMyChannelAPI;
		...
		if (0 == returnValue) {
			...
			System.out.println("获取我的渠道列表成功！\n");
		}
		else{
			System.out.println("获取我的渠道店铺列表失败！"+responseEntiy+"\n");
		}
